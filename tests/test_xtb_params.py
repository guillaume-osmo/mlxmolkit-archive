...
@pytest.mark.xfail(strict=True, reason="carbon KCNS parses as -0.55477603 against an expected -5.5477603 — exactly 10x, so a parser field-width or scaling error rather than drift. Whichever side is wrong, GFN0 carbon is currently using one of them. See #63.")
